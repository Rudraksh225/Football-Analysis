...
<img src="output_videos/screenshot.png" alt="Project Output Preview" width="80%"/>
...
| Library | Role |
|---|---|
| [Ultralytics YOLOv8, YOLO26](https://github.com/ultralytics/ultralytics) | Object detection |
...
| Asset | Link |
|---|---|
| YOLO weights (yolov8) (`best.pt`) | [Google Drive](https://drive.google.com/file/d/1DC2kCygbBWUKheQ_9cFziCsYVSRw6axK/view?usp=sharing) |
| YOLO weights (yolo26) (`best_2.pt`) | [Google Drive](https://drive.google.com/file/d/1bbVuf6HSpAdLnere7zjpS7OcMm-Bn8iW/view?usp=sharing) |
